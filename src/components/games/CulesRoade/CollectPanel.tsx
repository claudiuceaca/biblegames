  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.collectRow}>
        <Image source={require('@/assets/images/roade/Mar.png')} style={styles.collectIcon} />
        <Text style={styles.collectText}>+1</Text>
      </View>
      <View style={styles.collectRow}>
        <Image source={require('@/assets/images/roade/Strugure.png')} style={styles.collectIcon} />
        <Text style={styles.collectText}>+2</Text>
      </View>
      <View style={styles.collectRow}>
        <Image source={require('@/assets/images/roade/Grau.png')} style={styles.collectIcon} />
